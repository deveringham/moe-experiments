...
# basic_models.py
#
# Definition of basic Transformer components and model architectures.
...
class Decoder(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim=256, ff_dim=2048, dropout=0.1, n_decoder_layers=4, n_heads=4,
        ...
        self.decoder_layers = nn.ModuleList([
            DecoderLayer(embedding_dim, ff_dim, dropout, n_heads, using_encoder=using_encoder) for _ in range(n_decoder_layers)])
...
class TransformerLM(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # Decoder output shape [batch, tgt_seq_len, vocab_size]
